%Code adapted from the week 9 workshop on Sentiment Analysis using Bing Liu opinion lexicon;
%--------------------Clear workspace--------------------
clc
clear
%-----------------Read pos/neg words from lexicon------------------
...
% Find the number of all sentimentScore's equal to 0, either not found or neutral
ZeroVal = sum(sentimentScore == 0);
% Find all of the 'distinct' values 
